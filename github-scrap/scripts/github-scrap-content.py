...
contents = ['import tensorflow', 'from tensorflow', 'from tensorflow import']
...
access_token = "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"
session = create_github_session()
names = df.name.to_list()

with open('json/ml_repos_sorted_tensorflow_v1.jsonl', 'a') as f_repos:
